...
function page() {
  ...
  return (
    <section className="relative bg-cover bg-[url('/assets/gradient.png')] h-screen">
      <div className="container mx-auto max-w-7xl flex flex-col items-center justify-between px-10 py-20">
        <h1 className='text-white font-bold text-[40px]'>Exchange mfer</h1>
        <div className='bg-white flex flex-col gap-4 rounded-lg shadow-slate-300 shadow-md px-6 py-4'>
          <ExchangeForm />
        </div>
      </div>
    </section>
